...
describe("ChessBoard", () => {
  test("chessboard square are identified properly", () => {
    ...
    expect(chessBoard.getSquareCode(new BoardPosition(0, 0))).toBe("a1");
    expect(chessBoard.getSquareCode(new BoardPosition(7, 7))).toBe("h8");
  });
  test("chessboard initial pieces are there", () => {
    const chessBoard = new ChessBoard();
    expect(chessBoard.getPiece(new BoardPosition(0, 0))?.getType()).toBe(
      "Rook",
    );
    expect(chessBoard.getPiece(new BoardPosition(1, 0))?.getType()).toBe(
      "Knight",
    );
    expect(chessBoard.getPiece(new BoardPosition(2, 0))?.getType()).toBe(
      "Bishop",
    );
    expect(chessBoard.getPiece(new BoardPosition(3, 0))?.getType()).toBe(
      "Queen",
    );
    expect(chessBoard.getPiece(new BoardPosition(4, 0))?.getType()).toBe(
      "King",
    );
    expect(chessBoard.getPiece(new BoardPosition(5, 0))?.getType()).toBe(
      "Bishop",
    );
    expect(chessBoard.getPiece(new BoardPosition(6, 0))?.getType()).toBe(
      "Knight",
    );
    expect(chessBoard.getPiece(new BoardPosition(7, 0))?.getType()).toBe(
      "Rook",
    );
    for (let i = 0; i < 8; i++) {
      expect(chessBoard.getPiece(new BoardPosition(i, 1))?.getType()).toBe(
        "Pawn",
      );
    }
    for (let i = 0; i < 8; i++) {
      expect(chessBoard.getPiece(new BoardPosition(i, 6))?.getType()).toBe(
        "Pawn",
      );
    }
    expect(chessBoard.getPiece(new BoardPosition(0, 7))?.getType()).toBe(
      "Rook",
    );
    expect(chessBoard.getPiece(new BoardPosition(1, 7))?.getType()).toBe(
      "Knight",
    );
    expect(chessBoard.getPiece(new BoardPosition(2, 7))?.getType()).toBe(
      "Bishop",
    );
    expect(chessBoard.getPiece(new BoardPosition(3, 7))?.getType()).toBe(
      "Queen",
    );
    expect(chessBoard.getPiece(new BoardPosition(4, 7))?.getType()).toBe(
      "King",
    );
    expect(chessBoard.getPiece(new BoardPosition(5, 7))?.getType()).toBe(
      "Bishop",
    );
    expect(chessBoard.getPiece(new BoardPosition(6, 7))?.getType()).toBe(
      "Knight",
    );
    expect(chessBoard.getPiece(new BoardPosition(7, 7))?.getType()).toBe(
      "Rook",
    );
